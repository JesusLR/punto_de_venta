...
<input type="text" id="iIDMaterial" hidden>
    <div class="row">
        <div class="col-12">
            <h1>Materiales <i class="fas fa-book"></i></h1>
            @if (Auth::user()->id == 1)
                <a href="#" id="btnAgregarMaterial" class="btn btn-success mb-2"  title="Agregar Material"><i class="fas fa-plus"></i> Agregar</a>
    ...
    @include('materiales.modals.formMaterial')
